...
public class CarteTests
{
    ...
    {
        // Arrange
        var carte = new Carte(RangCarte.As, Couleur.Pique);
    ...
    {
        // Arrange
        var carte = new Carte(RangCarte.Dix, Couleur.Carreau);
    ...
    {
        // Arrange
        var carte1 = new Carte(RangCarte.Dame, Couleur.Coeur);
        var carte2 = new Carte(RangCarte.Dame, Couleur.Coeur);
