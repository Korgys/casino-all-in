...
{
    [TestMethod]
    public void Constructeur_DoitDistribuerLesCartesUniquementAuxJoueursEligibles()
    {
        // Arrange
    ...
    public void AvancerPhase_PreFlopVersFlop_DoitRevelerTroisCartesEtMettreAJourLEtat()
    {
        ...
        Assert.IsInstanceOfType(partie.PhaseState, typeof(FlopPhaseState), "L'état doit être mis à jour pour le flop.");
