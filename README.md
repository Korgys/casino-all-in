...
- **Roulette** game in the terminal with straight-up, red/black, and odd/even bets.
...
- [.NET SDK 11.0](https://dotnet.microsoft.com/) (target framework: `net11.0`)
- or Docker
...
- `casino.core/Properties/Languages/Resources.Designer.cs` is intentionally excluded from coverage because it is auto-generated resource designer code and does not represent manually maintained business logic.
...
```text
casino-all-in/
├── casino.core/           # Domain/game engine (rules, cards, scores, phases, players, slots, roulette)
...
- [ ] Add additional casino games (Craps, etc.).
